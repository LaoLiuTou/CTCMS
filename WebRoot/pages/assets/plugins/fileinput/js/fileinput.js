...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-kv btn-default btn-outline-dark',
                    removeErrorClass: 'btn btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fa fa-cloud-upload"></i>',
                    uploadClass: 'btn btn-kv btn-default btn-outline-dark',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-kv btn-default btn-outline-dark',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fa fa-arrows"></i>',
                    zoomClass: 'btn btn-kv btn-default btn-outline-dark',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-kv btn-default btn-outline-dark',
            fullscreen: 'btn btn-kv btn-default btn-outline-dark',
            borderless: 'btn btn-kv btn-default btn-outline-dark',
            close: 'btn btn-kv btn-default btn-outline-dark'
        },
