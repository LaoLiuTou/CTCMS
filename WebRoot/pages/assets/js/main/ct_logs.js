 ...
 * 查询单条资讯
 */
function selectLogs(id){
    var bodyParam={'id':id};
    var httpR = new createHttpR(url+'selectLogs','post','text',bodyParam,'callBack');
 ...
 * 添加
 */
function addLogs(bodyParam){
    var httpR = new createHttpR(url+'addLogs','post','text',bodyParam,'callBack');
    httpR.HttpRequest(function(response){
        var obj = JSON.parse(response);
        var status = obj['status'];
        //var msg = obj['msg'];
 ...
 * @param id
 */
function updateLogs(bodyParam){

    var httpR = new createHttpR(url+'updateLogs','post','text',bodyParam,'callBack');
    httpR.HttpRequest(function(response){
        var obj = JSON.parse(response);
        var status = obj['status'];
        //var msg = obj['msg'];
...
function deleteLogs(id){
    var bodyParam={'id':id};
    var httpR = new createHttpR(url+'deleteLogs','post','text',bodyParam,'callBack');
    httpR.HttpRequest(function(response){
        var obj = JSON.parse(response);
        var status = obj['status'];
        //var msg = obj['msg'];
 ...
 * @param pageSize
 */
function  queryLogs (user_id,currentPage,pageSize) {
    ...
    var httpR = new createHttpR(url+'listLogs','post','text',bodyParam,'callBack');
    httpR.HttpRequest(function(response){
        var obj = JSON.parse(response);
        var status = obj['status'];
        var msg = obj['msg'];
